...
**A holder can cherry-pick.** You can disclose three payments and withhold a fourth, and nothing in a proof detects it. Completeness routes through your auditor, not through you. Any claim that Pocket proves a *complete* history would be false.
...
The producer and verifier wait on the two disclosure circuits, which is what makes the proof in such a bundle a real one. Until those are ported, a flow built over the primitives would hand a counterparty an unverifiable number dressed as a proven one.
