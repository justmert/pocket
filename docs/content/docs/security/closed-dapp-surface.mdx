...
Behind it sits the strongest reason, which depends on no code Pocket wrote: a confidential operation needs a valid proof over the account's own viewing key, and a website cannot produce one. [All three boundaries](/docs/security/trust-boundaries).
