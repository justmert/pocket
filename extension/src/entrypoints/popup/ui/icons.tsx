// the icon set.
//
// geometry is vendored from hugeicons (free tier, mit, stroke-rounded) as plain
// paths, so nothing is fetched at runtime and the mv3 content policy has nothing
// to block. one shared svg sets stroke, currentColor and round caps, so a glyph
// recolours through `color` and reweights through `sw` instead of each icon
